...
const FindIdForm = (props)=>{
    ...
    const onRequest = async()=>{
        ...
        if(name === "" || target === "" ) setErrorText({text:t("alert_find_11"),color:"#EE1818"});
        else {
            if ( request === true ) {
        ...
        <>
            <View style={{marginTop:20}}>
                <View style={{borderWidth:1,borderColor:"#B6B6B6",padding:16,borderRadius:6}}>
                    <TextInput placeholderTextColor={"#A7A7A7"} placeholder={t("login_find_5")} onChangeText={text=>setName(text)} style={{padding:0,fontSize:13,color:"#2B2B2B",height:20,fontFamily:"NotoSans-Regular"}}/>
                </View>
